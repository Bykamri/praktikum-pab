...
class DokterJantungPage extends StatefulWidget {
  const DokterJantungPage({super.key});

  @override
  State<DokterJantungPage> createState() => _DokterJantungPageState();
}

class _DokterJantungPageState extends State<DokterJantungPage> {
  @override
